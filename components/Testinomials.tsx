    ...
    >
      <div className="max-w-6xl mt-24 md:mt-4 mx-auto px-4">
        ...
        <div className="relative -mx-4 overflow-hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-16 md:w-32 bg-gradient-to-r from-background via-background/80 to-transparent pointer-events-none z-10" />
          <div className="absolute inset-y-0 right-0 w-16 md:w-32 bg-gradient-to-l from-background via-background/80 to-transparent pointer-events-none z-10" />
        </div>
      </div>
